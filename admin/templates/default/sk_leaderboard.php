...
class sk_leaderboard
{
	...
	function leaderboardVenueHeaderCSV($venue)
	{
		$HTML = <<<HTML
{$venue},
HTML;
	...
	function leaderboardVenueColCSV($stat)
	{
		$HTML = <<<HTML
{$stat},
HTML;
	...
	function leaderboardTable($val, $nav="")
	{
		$html = <<<EOF
...
EOF;
	...
	function CSVRow( $leaderboard, $venue_cols )
	{
		$html = ("
{$leaderboard['user']['lastName']},{$leaderboard['user']['firstName']},{$venue_cols},{$leaderboard['distinct_venues']},{$leaderboard['nonvenue']},{$leaderboard['bounty']},{$leaderboard['total_wins']},{$leaderboard['high_hand']},{$leaderboard['xtra_points']},{$leaderboard['hands_played']},{$leaderboard['event_points']},{$leaderboard['chip_bonus_vnv']},{$leaderboard['chip_total']},{$leaderboard['point_total']},{$leaderboard['points_ytd']}\n
");
		return $html;
	}
